...
export default async function UserProfilePage() {
	...
	return (
		<div className="max-w mx-auto flex h-screen max-w-6xl flex-col gap-y-5 py-5 pt-28 ">
			<Tabs defaultValue="thong-tin-chung" orientation="vertical" className="flex h-full gap-5">
